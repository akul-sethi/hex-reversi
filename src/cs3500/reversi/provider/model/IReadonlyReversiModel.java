...
public interface IReadonlyReversiModel {
   ...
   * @throws IllegalStateException if game has not been started
   */
  HashMap<Hexagon, HexagonState> getCopyBoardHashMap();
   ...
   * @throws IllegalStateException if game has not been started
   */
  IPlayer getPlayer(HexagonState state);
   ...
   * @throws IllegalStateException if game has not been started
   */
  int getNumPiecesGainedForMove(Hexagon h, HexagonState s);
   ...
   * @throws IllegalStateException if game has not been started
   */
  boolean isHexagonNextToCorner(Hexagon h);
   ...
   * @throws IllegalStateException if game has not been started
   */
  boolean isHexagonInCorner(Hexagon h);
