 ...
 * players (AI, Human, etc) which can play the game. It is generally observed by an InputObserver
 * so that it can request inputs it would like to make to a ReversiModel.
 */
